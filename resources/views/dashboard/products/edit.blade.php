                            ...
                            <div class="col-md-12">
                                <div class="card mb-4">
                                    ...
                                    <form id="formAccountSettings" method="POST"
                                        action={{ url("/dashboard/products/$product->id") }} class="card-body"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" type="text" name="description" placeholder="Description" autocomplete="off">{{ $product->description }}</textarea>
                                            </div>
